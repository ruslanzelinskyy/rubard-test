var Site = {
    ...
    ajax: {
        ...
        beforeSend: function () {
            this.obj.data[1]['value'] = this.obj.data[1]['value'].replace(/\)/g, ''); //prepare phone
            this.obj.data[1]['value'] = this.obj.data[1]['value'].replace(/\(/g, '');
            this.obj.data[1]['value'] = this.obj.data[1]['value'].replace(/\-/g, '');
            this.obj.data[1]['value'] = this.obj.data[1]['value'].replace(/\+/g, '');
            this.obj.data[1]['value'] = this.obj.data[1]['value'].replace(/\_/g, '');
